...
> scenes, devices, and many automation details that are not exposed by Apple's
> public HomeKit APIs.
...
**completely separate namespace**. They do not reliably match:
...
*Generated for the HomeKit Inspector project. Based on observations from a
